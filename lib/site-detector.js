...
const DEFAULT_SITES = [
  ...
  { id: 'gemini', name: 'Gemini', icon: 'G', enabled: true, patterns: ['gemini.google.com', 'bard.google.com'],
    inputSelectors: ['div[contenteditable="true"]', 'rich-textarea div[contenteditable]', '.ql-editor'] },
  { id: 'grok', name: 'Grok', icon: 'X', enabled: true, patterns: ['grok.x.ai', 'x.com/i/grok'],
    inputSelectors: ['textarea', 'div[contenteditable="true"]'] },
  { id: 'copilot', name: 'Microsoft Copilot', icon: 'MS', enabled: true, patterns: ['copilot.microsoft.com', 'bing.com/chat'],
  ...
  { id: 'poe', name: 'Poe', icon: 'POE', enabled: true, patterns: ['poe.com'],
    inputSelectors: ['textarea', 'div[contenteditable="true"]'] },
  { id: 'huggingchat', name: 'HuggingChat', icon: 'HF', enabled: true, patterns: ['huggingface.co/chat'],
    inputSelectors: ['textarea', 'div[contenteditable="true"]'] },
